      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            ...
            <a href="book.php" class="small-box-footer">Details <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-maroon">
            ...
            <a href="student.php" class="small-box-footer">Details <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-olive">
            ...
            <a href="return.php" class="small-box-footer">Details <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            ...
            <a href="borrow.php" class="small-box-footer">Details <i class="fa fa-angle-double-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
